...
static const char const h_prolog[] =
    "#include <stdint.h>\n";
...
#undef check_lang
    ...
    *p = 'h';
	...
	fputs (*cpp, cfile);
    fprintf(cfile,
	    "const struct error_table et_%s_error_table = { text, (int32_t) %ld, %d };",
    ...
    fprintf (hfile, "#define ERROR_TABLE_BASE_%s ((uint32_t) %ld)\n",
